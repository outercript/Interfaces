...
quickly with CodeWarrior for MC9S12XEP100.
...
of your choice:
- SofTec HCS12:
  This Connection allows to debug with any of the USB-based SofTec Microsystems 
  tools for HCS12 or HCS12X (inDART-HCS12, etc...).
  Please check the SofTec Microsystems hardware documentation for additional details.
