...
volatile ECT_OCPDSTR _ECT_OCPD;                            /* Ouput Compare Pin Disconnect Register; 0x0000006C */
volatile ECT_PTPSRSTR _ECT_PTPSR;                          /* Precision Timer Prescaler Select; 0x0000006E */
...
volatile IIC1_IBADSTR _IIC1_IBAD;                          /* IIC 1 Address Register; 0x000000B0 */
volatile IIC1_IBFDSTR _IIC1_IBFD;                          /* IIC 1 Frequency Divider Register; 0x000000B1 */
volatile IIC1_IBCRSTR _IIC1_IBCR;                          /* IIC 1 Control Register; 0x000000B2 */
volatile IIC1_IBSRSTR _IIC1_IBSR;                          /* IIC 1 Status Register; 0x000000B3 */
volatile IIC1_IBDRSTR _IIC1_IBDR;                          /* IIC 1 Data I/O Register; 0x000000B4 */
volatile IIC1_IBCR2STR _IIC1_IBCR2;                        /* IIC 1 Control Register 2; 0x000000B5 */
...
volatile IIC0_IBCR2STR _IIC0_IBCR2;                        /* IIC 0 Control Register 2; 0x000000E5 */
...
volatile FPROTSTR _FPROT;                                  /* Flash Protection Register; 0x00000108 */
...
volatile MPUSELSTR _MPUSEL;                                /* MPU Descriptor Select Register; 0x00000118 */
volatile MPUDESC0STR _MPUDESC0;                            /* MPU Descriptor Register 0; 0x00000119 */
volatile MPUDESC1STR _MPUDESC1;                            /* MPU Descriptor Register 1; 0x0000011A */
volatile MPUDESC2STR _MPUDESC2;                            /* MPU Descriptor Register 2; 0x0000011B */
volatile MPUDESC3STR _MPUDESC3;                            /* MPU Descriptor Register 3; 0x0000011C */
volatile MPUDESC4STR _MPUDESC4;                            /* MPU Descriptor Register 4; 0x0000011D */
volatile MPUDESC5STR _MPUDESC5;                            /* MPU Descriptor Register 5; 0x0000011E */
...
volatile CAN2MISCSTR _CAN2MISC;                            /* MSCAN 2 Miscellaneous Register; 0x000001CD */
...
volatile CAN3MISCSTR _CAN3MISC;                            /* MSCAN 3 Miscellaneous Register; 0x0000020D */
...
volatile PT0AD0STR _PT0AD0;                                /* Port AD0 Data Register 0; 0x00000270 */
volatile PT1AD0STR _PT1AD0;                                /* Port AD0 Data Register 1; 0x00000271 */
volatile DDR0AD0STR _DDR0AD0;                              /* Port AD0 Data Direction Register 0; 0x00000272 */
volatile DDR1AD0STR _DDR1AD0;                              /* Port AD0 Data Direction Register 1; 0x00000273 */
volatile RDR0AD0STR _RDR0AD0;                              /* Port AD0 Reduced Drive Register 0; 0x00000274 */
...
volatile PTRSTR _PTR;                                      /* Port R I/O Register; 0x00000368 */
...
volatile PTLSTR _PTL;                                      /* Port L I/O Register; 0x00000370 */
...
volatile PTFSTR _PTF;                                      /* Port F I/O Register; 0x00000378 */
...
volatile TIM_PTPSRSTR _TIM_PTPSR;                          /* Precision Timer Prescaler Select; 0x000003FE */
volatile TIM_TPORTESTR _TIM_TPORTE;                        /* Timer Port Enable Register; 0x000003FF */
...
volatile ATD1CTL01STR _ATD1CTL01;                          /* ATD 1 Control Register; 0x00000080 */
volatile ATD1CTL23STR _ATD1CTL23;                          /* ATD 1 Control Register; 0x00000082 */
volatile ATD1CTL45STR _ATD1CTL45;                          /* ATD 1 Control Register; 0x00000084 */
...
volatile ETAGSTR _ETAG;                                    /* EEE Tag Counter Register High; 0x0000010C */
...
volatile ATD0CTL01STR _ATD0CTL01;                          /* ATD 0 Control Register; 0x000002C0 */
volatile ATD0CTL23STR _ATD0CTL23;                          /* ATD 0 Control Register; 0x000002C2 */
volatile ATD0CTL45STR _ATD0CTL45;                          /* ATD 0 Control Register; 0x000002C4 */
